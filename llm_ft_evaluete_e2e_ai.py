...
# @File : llm_ft_evaluete_e2e_ai.py
...
DEV_DATA_PATH = "/home/xiezizhe/wuzixun/LLM/ChatGLM-Tuning/data/ks_ai_ft/ai_ft_0512_0513_format.json"
...
if __name__ == "__main__":
    ...
    sheet.cell(1, 3).value = 'FT'
    sheet.cell(1, 4).value = "FAQ识别后对应FT"
    sheet.cell(1, 5).value = "一级FT是否正确"
    sheet.cell(1, 6).value = "二级FT是否正确"
    ...
    for sample in tqdm(dev_data):
        try:
            ...
            sheet.cell(nrow, 3).value = ft_1_2_label
            ...
            sheet.cell(nrow, 5).value = is_first_equal(ft_1_2_label, ft)
            sheet.cell(nrow, 6).value = is_second_equal(ft_1_2_label, ft)
